...
onMounted(() => {
  ...
  if (storedTeacherInfo && Array.isArray(storedTeacherInfo.researchAreas)) {
    teacherInfo.value.researchAreas = storedTeacherInfo.researchAreas
  } else {
    teacherInfo.value.researchAreas = []
  }
